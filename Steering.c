...
// duty cycles that correspond to a fully left and right turn respectively.
// Tuned to our specific car
#define LEFT_DC 4.0
#define	RIGHT_DC 8.1
...
// helper function for setting FTM duty cycle
void set_duty_cycle(float duty_cycle)
{
		// change FTM modulus and reset clock
...
{
		// saturate input to [0,1]
		if (dir < 0)
			dir = 0;
		else if (dir > 1)
			dir = 1;
		
		// map this input to the servo duty cycle range
